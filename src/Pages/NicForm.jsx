...
const NicForm = () => {
    ...
    return (
        <div className="flex flex-col items-center w-[90%] mx-auto m-5 my-10 min-h-screen"> 
            ...
            <div className='flex flex-col lg:flex-row gap-10 bg-gray-200 rounded-2xl p-10 shadow-lg'>

                {/* left side */}
                <div className='my-auto'>
                    
                    <div className="mb-4 flex grid-flow-col lg:flex-col grid-cols-4 items-start space-y-5"  data-aos="fade-right" data-aos-anchor-placement="top-bottom" data-aos-duration="1000">
